        ...
        it('should calculate house effects with temporal windows', () => {
            const mockPolls: ParsedPoll[] = [
                ...
                },
                {
                    ...
                    year: 2025,
                    day: 15,
                    parties: { Ap: 27, Høyre: 17, Frp: 18, SV: 8, Sp: 5, KrF: 3, Venstre: 6, MDG: 6, Rødt: 4, Andre: 6 }
                },
                {
                    house: 'House3',
                    date: '1/9-2025', 
                    ...
                    year: 2025,
                    day: 1,
                    parties: { Ap: 30, Høyre: 20, Frp: 15, SV: 7, Sp: 8, KrF: 4, Venstre: 5, MDG: 5, Rødt: 3, Andre: 3 }
                }
            ];
            ...
            const mockPolls: ParsedPoll[] = [
                {
                    ...
                    year: 2025,
                    day: 1,
                    parties: { Ap: 28, Høyre: 18, Frp: 20, SV: 6, Sp: 7, KrF: 5, Venstre: 4, MDG: 4, Rødt: 6, Andre: 2 }
                },
                {
                    house: 'House1',
                    date: '15/8-2025',
                    ...
                    year: 2025,
                    day: 15,
                    parties: { Ap: 30, Høyre: 20, Frp: 18, SV: 8, Sp: 5, KrF: 3, Venstre: 6, MDG: 4, Rødt: 4, Andre: 2 }
                },
                {
                    house: 'House2',
                    date: '2/8-2025',
                    ...
                    year: 2025,
                    day: 2,
                    parties: { Ap: 24, Høyre: 14, Frp: 22, SV: 6, Sp: 7, KrF: 5, Venstre: 4, MDG: 6, Rødt: 8, Andre: 4 }
                },
                {
                    house: 'House2',
                    date: '16/8-2025',
                    ...
                    year: 2025,
                    day: 16,
                    parties: { Ap: 22, Høyre: 12, Frp: 24, SV: 8, Sp: 9, KrF: 7, Venstre: 2, MDG: 8, Rødt: 6, Andre: 2 }
                }
            ];
